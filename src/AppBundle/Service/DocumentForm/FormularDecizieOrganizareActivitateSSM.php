...
class FormularDecizieOrganizareActivitateSSM extends FormularGeneric
{
    ...
    function getEntity()
    {
        return 'AppBundle\Document\DecizieOrganizareActivitateSSM\DecizieOrganizareActivitateSSM';
    }
