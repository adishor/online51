...
class LoadDomainData extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $domain->setDemoDomain(TRUE);
        $domain->setDemoCreditValue(5);
