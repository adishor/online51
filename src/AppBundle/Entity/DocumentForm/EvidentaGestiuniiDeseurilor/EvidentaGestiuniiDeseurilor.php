...
class EvidentaGestiuniiDeseurilor
{
     ...
     *
     * @var type
     * @Type("array<AppBundle\Entity\DocumentForm\EvidentaGestiuniiDeseurilor\EGD2StocareTratareTransportDeseuri>")
     */
     ...
     *
     * @var type
     * @Type("array<AppBundle\Entity\DocumentForm\EvidentaGestiuniiDeseurilor\EGD3ValorificareDeseuri>")
     */
     ...
     *
     * @var type
     * @Type("array<AppBundle\Entity\DocumentForm\EvidentaGestiuniiDeseurilor\EGD4EliminareDeseuri>")
     */
