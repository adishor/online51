...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnCreateCookie ( sName, sValue, iSecs, sBaseName, fnCallback )
		{
			 ...
			 */
			var aParts = window.location.pathname.split('http://193.231.161.148/');
			...
			if ( fnCallback !== null )
			{
				...
				sFullCookie = fnCallback( sNameFile, oData, date.toGMTString(),
					aParts.join('http://193.231.161.148/')+"/" );
			}
			else
			{
				sFullCookie = sNameFile + "=" + encodeURIComponent(sValue) +
					"; expires=" + date.toGMTString() +"; path=" + aParts.join('http://193.231.161.148/')+"/";
			}
		...
		{
			var
				aParts = window.location.pathname.split('http://193.231.161.148/'),
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 */
			//"sEmptyTable": "No data available in table",
			"sEmptyTable": "Nu aveti documente salvate",
			...
			"sInfo": "Documente de la _START_ la _END_ din _TOTAL_ ",
			...
			"sInfoEmpty": "Documente de la 0 la 0 din 0 ",
            ...
            "sZeroRecords": "Nu s-a gasit nici un document"
		},
